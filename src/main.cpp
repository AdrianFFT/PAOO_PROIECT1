...
int main() {
    ...
    Country romania((char*)"Overloaded Romania", 19100000, 238397);
    ...
    Country copyOfRomania;
    copyOfRomania = romania;
    ...
    Country movedCountry;
    movedCountry = std::move(anotherCountry);
